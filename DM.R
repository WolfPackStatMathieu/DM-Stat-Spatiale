...
# se concentrent avant tout autour du quartier de la gare, ainsi que dans une
# moindre mesure sur la rive droite qui est une zone plus récente avec de
# nombreuses tours. A l'inverse, l'ouest est constitués d'une plus faible part
# de ménages pauvres. Il s'agit de quartiers plus résidentiels composés
...
# De plus, on observe une concentration des observations dans le cadran low-low (en bas
# à gauche). Les carreaux avec une faible part de ménages pauvres sont entourés
# de carreaux ayant une faible part de ménages pauvres.
...
# toute observation située dans un rayon de X km. Dans ce cas, il faut définir
